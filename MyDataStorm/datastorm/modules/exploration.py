...
class ExplorationFramework:
    ...
    def run(
        ...
        logger.info(
            ...
            p,
            self._config.exploration.early_stop_patience,
        )
        ...
        for layer in range(1, m + 1):
            ...
            # 为每个问题分配唯一 ID 并创建 QuestionNode (执行前先记录问题本身)
            ...
            # db_responses 和 db_questions_with_idx 按相同顺序排列
